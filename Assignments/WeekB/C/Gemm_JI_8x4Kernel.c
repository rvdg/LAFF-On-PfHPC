...
void Gemm_JI_8x4Kernel( int, int, int, double *, int, double *, int, double *, int );

void Gemm_8x4Kernel( int, double *, int, double *, int, double *, int );

void GemmWrapper( int m, int n, int k, double *A, int ldA,
		  double *B, int ldB, double *C, int ldC )
{
  Gemm_JI_8x4Kernel( m, n, k, A, ldA, B, ldB, C, ldC );
}

void Gemm_JI_8x4Kernel( int m, int n, int k,
                              double *A, int ldA,
                              double *B, int ldB,
                              double *C, int ldC )
{
...
void Gemm_8x4Kernel( int k, double *A, int ldA,
                             double *B, int ldB, double *C, int ldC )
{
  ...
  for ( int p=0; p<k; p++ ){
    /* Declare two vector registers to hold the current column of A and load
       it with the eight elements of that column. */
