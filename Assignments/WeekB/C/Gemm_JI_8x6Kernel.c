...
void Gemm_JI_8x6Kernel( int m, int n, int k,
                              double *A, int ldA,
                              double *B, int ldB,
                              double *C, int ldC )
{
...
void Gemm_8x6Kernel( int k, double *A, int ldA,
                             double *B, int ldB, double *C, int ldC )
{
  ...
  for ( int p=0; p<k; p++ ){
    ...
    /* duplicate  beta( p,4 ) in the register. */
    ...
    /* duplicate  beta( p,5 ) in the register. */
